...
package com.cloudy.common.entity.search.utils;

import com.cloudy.common.entity.search.SearchOperator;
import com.cloudy.common.entity.search.Searchable;
import com.cloudy.common.entity.search.exception.InvalidSearchPropertyException;
import com.cloudy.common.entity.search.exception.InvalidSearchValueException;
import com.cloudy.common.entity.search.exception.SearchException;
import com.cloudy.common.entity.search.filter.AndCondition;
import com.cloudy.common.entity.search.filter.Condition;
import com.cloudy.common.entity.search.filter.OrCondition;
import com.cloudy.common.entity.search.filter.SearchFilter;
...
public final class SearchableConvertUtils {
     ...
     * value="com.ibm.common.entity.search.utils.SearchableConvertUtils.setConversionService"/>
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [com.ibm.common.entity.search.utils." +
