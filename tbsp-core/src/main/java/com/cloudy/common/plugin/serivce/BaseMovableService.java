...
import com.cloudy.common.plugin.entity.Movable;
 ...
 * <p>Version: 1.0
 */
public abstract class BaseMovableService<M extends BaseEntity & Movable, ID extends Serializable> extends AbstractBaseService<M, ID> {
