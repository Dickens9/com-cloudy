 ...
 */
package com.cloudy.common.plugin.serivce;
...
import com.cloudy.common.entity.search.filter.SearchFilterHelper;
import com.cloudy.common.plugin.entity.Treeable;
import com.cloudy.common.repository.RepositoryHelper;
import com.cloudy.common.service.impl.AbstractBaseService;
import com.cloudy.common.utils.ReflectUtils;
...
public abstract class BaseTreeableService<M extends BaseEntity<ID> & Treeable<ID>, ID extends Serializable>
        extends AbstractBaseService<M, ID> {
