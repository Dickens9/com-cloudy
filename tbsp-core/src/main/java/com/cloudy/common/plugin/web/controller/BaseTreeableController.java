 ...
 */
package com.cloudy.common.plugin.web.controller;

import com.cloudy.common.Constants;
import com.cloudy.common.entity.BaseEntity;
import com.cloudy.common.entity.enums.BooleanEnum;
import com.cloudy.common.entity.search.SearchOperator;
import com.cloudy.common.entity.search.Searchable;
import com.cloudy.common.plugin.entity.Treeable;
import com.cloudy.common.plugin.serivce.BaseTreeableService;
import com.cloudy.common.plugin.web.controller.entity.ZTree;
import com.cloudy.common.web.bind.annotation.PageableDefaults;
import com.cloudy.common.web.controller.TreeBaseController;
import com.cloudy.common.web.controller.permission.PermissionList;
...
public abstract class BaseTreeableController<M extends BaseEntity<ID> & Treeable<ID>, ID extends Serializable>
        extends TreeBaseController<M, ID> {
