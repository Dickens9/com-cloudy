package com.cloudy.common.repository.jdbc;
...
public abstract class JdbcTemplateHelper<E> {
	...
	public static final String COUNT_QUERY_STRING = "select count(1) from (%s) ";
	public static final String PAGE_QUERY_STRING = "SELECT ROW_.*, ROWNUM  FROM (%s) ROW_ WHERE ROWNUM >= ? AND ROWNUM < ?";
