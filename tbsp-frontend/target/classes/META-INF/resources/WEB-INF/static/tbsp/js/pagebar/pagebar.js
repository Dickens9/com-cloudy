...
;(function($){  
    ...
    $.fn.pagebar = function(options){
        ...
        this.settings.pageWidget = $(this.get(0));  
    ...
    var bindEvent = function(options){  
     ...
     var gotoPage = function(options){
         var gotoPageInput = $("#gotoPageInput").val();
    ...
    var buildPage = function(page,options){  
        ...
        if(totalPageNum <= 7){  
            ...
            }else if(totalPageNum-currPageNum >= 2){
               //显示1,2页
               for(var i = 1;i <= 2 ;i++){
                    options.pageWidget.find("div[class='digg4 metpager_8']").append("<a pageNum='"+i+"' href='javascript:void(0);'>"+i+"</a>");  
               }
            ...
            if(totalPageNum > 7 && totalPageNum-currPageNum > 2){
                options.pageWidget.find("div[class='digg4 metpager_8']").append("<span> ... </span>");  
            }
        }  
        ...
        options.pageWidget.find("div[class='digg4 metpager_8']").append("<span class='' style='margin-left:10px;'>共"+totalPageNum+"页 </span>");  
        if(totalPageNum == 0){
        	...
        	options.pageWidget.find("div[class='digg4 metpager_8']").append("<span>到第<input type='text' class='gotoPageInput' id='gotoPageInput' style='width:30px;' value='"+currPageNum+"' onkeyup='javascript:RepNumber(this)'/>页&nbsp;<input type='button' class='btn' value='确定'/></span>");  
        }
