    ...
    liger.win = {
        ...
        setFront: function (win)
        {
            ...
            for (var i in wins)
            {
                ...
                {
                    $(w.element).css("z-index", "8900");
                }
            }
        },
        //前端显示
        setPreviousFront: function (win)
        {
        	var wins = liger.find(liger.core.Win);
        	for (var i in wins)
        	{
...
(function ($)
{
    ...
    //dialog 图片文件夹的路径 预加载
    $.ligerui.DialogImagePath = "../../../../static/tbsp/js/ligerui/skins/Aqua/images/win/";
